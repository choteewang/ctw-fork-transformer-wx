...
function transform(options) {
    ...
    babel_traverse_1.default(ast, {
        ...
        ImportDeclaration(path) {
            ...
            if (source === constant_1.TARO_PACKAGE_NAME) {
                path.node.specifiers.push(t.importSpecifier(t.identifier(constant_1.INTERNAL_SAFE_GET), t.identifier(constant_1.INTERNAL_SAFE_GET)), t.importSpecifier(t.identifier(constant_1.INTERNAL_DYNAMIC), t.identifier(constant_1.INTERNAL_DYNAMIC)), t.importSpecifier(t.identifier(constant_1.INTERNAL_INLINE_STYLE), t.identifier(constant_1.INTERNAL_INLINE_STYLE)));
            }
    ...
    result = new class_1.Transformer(mainClass, options.sourcePath).result;
